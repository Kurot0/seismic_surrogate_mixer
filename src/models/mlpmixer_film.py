...
class Network(nn.Module):
    def __init__(self, img_size_in, img_size_out, patch_size, in_chans, out_chans, embed_dim,
        ...
        self.film_layer_xy = FilmLayer(embed_dim)
        self.film_layer_yx = FilmLayer(embed_dim)
    ...
    def forward(self, x, underground_data, **kwargs):
        ...
        x = (self.film_layer_xy(x, underground.expand_as(x)) + self.film_layer_yx(underground.expand_as(x), x)) / 2
